...
- 图片的应用方式
    ...
    2. 页面里 html
    3. js创建插入到页面元素
使用可选的两种loader file-loader  url-loader

file-loader 和 url-loader都不能处理html中的img，要用一个第三方的html-withimg-loader来处理
...
1. babel-loader：将es6+ 变成浏览器可运行的es5代码
安装【webpack4.x】
